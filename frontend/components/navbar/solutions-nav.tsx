...
const SolutionsNav: FC<SolutionsNavProps> = ({}) => {
    ...
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      ...
      >
        <div className="mb-4 w-full py-4 lg:border-b-[1px]">
          <span className="text-base font-semibold text-primary">For</span>
          <ul className="mt-1 w-full text-sm text-neutral-500">
            ...
            <li>
              <Link href="/teams" className="block py-2 hover:text-blue-600">
                Teams
              </Link>
            </li>
            <li>
              <Link href="/startups" className="block py-2 hover:text-blue-600">
                Startups
              </Link>
            </li>
            <li className="py-2">
        ...
        <div className="mb-4 w-full pb-0 pt-2">
          ...
          <ul className="mt-1 w-full text-sm text-neutral-500">
            <li>
              <Link href="/stories" className="block py-2 hover:text-blue-600">
                Customer stories
              </Link>
            </li>
            <li className="py-2">
