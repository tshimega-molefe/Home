        ...
        <div className="mb-4 lg:mb-0 lg:border-r-[1px] lg:px-4 lg:pr-10  ">
          <ul className="max-lg:pl-6">
            <li className="">
              <NavLeft
                main="swift stack"
                submain="Host your own business on The Stack"
                path2=""
            ...
            <li className="">
              <NavLeft
                main="swift-air"
                submain="Request private air travel on-demand"
                path2=""
            ...
            <li className="">
              <NavLeft
                main="script-ed"
                submain="Generate films, books, courses, and more with AI "
            ...
            <li className="">
              <NavLeft
                main="sea-point"
                submain="Purchase real estate with your cryptocurrency"
            ...
            <li>
              <NavLeft
                main="solo"
                submain="Create your own Solo account"
            ...
            <li>
              <NavLeft
                main="suite-sound"
                submain="Disover new artists for your events"
